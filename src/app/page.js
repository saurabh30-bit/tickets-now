...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-orange-500/30">
      ...
      {/* Hero Section with Glowing Radial Gradient */}
      ...
      <main className="w-full max-w-[1400px] mx-auto px-4 flex flex-col items-center pb-24 relative z-10">
        <div className="flex flex-wrap justify-center gap-6 mb-12 bg-black/40 backdrop-blur-md border border-gray-800 px-8 py-4 rounded-full shadow-2xl">
          ...
          <div className="flex items-center gap-3"><div className="w-4 h-4 bg-yellow-500 rounded-full shadow-[0_0_10px_#eab308]"></div> <span className="text-sm font-bold tracking-wider text-gray-300 uppercase">Reserved (5m)</span></div>
          <div className="flex items-center gap-3"><div className="w-4 h-4 bg-red-500 rounded-full shadow-[0_0_10px_#ef4444]"></div> <span className="text-sm font-bold tracking-wider text-gray-300 uppercase">Sold</span></div>
        </div>
